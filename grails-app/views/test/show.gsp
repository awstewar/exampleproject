	...
	<body>
		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<g:if test="${testInstance?.boo}">
				<li class="fieldcontain">
					<span id="boo-label" class="property-label"><g:message code="test.boo.label" default="Boo" /></span>
					
						<span class="property-value" aria-labelledby="boo-label"><g:fieldValue bean="${testInstance}" field="boo"/></span>
